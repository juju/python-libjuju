...
class FullStatus(Type):
    _toSchema = {'applications': 'applications', 'machines': 'machines', 'model': 'model', 'offers': 'offers', 'relations': 'relations', 'remote_applications': 'remote-applications'}
    _toPy = {'applications': 'applications', 'machines': 'machines', 'model': 'model', 'offers': 'offers', 'relations': 'relations', 'remote-applications': 'remote_applications'}
    def __init__(self, applications=None, machines=None, model=None, offers=None, relations=None, remote_applications=None, **unknown_fields):
        '''
...
class ModelFilesystemInfo(Type):
    _toSchema = {'detachable': 'detachable', 'id_': 'id', 'provider_id': 'provider-id', 'status': 'status'}
    _toPy = {'detachable': 'detachable', 'id': 'id_', 'provider-id': 'provider_id', 'status': 'status'}
    def __init__(self, detachable=None, id_=None, provider_id=None, status=None, **unknown_fields):
        '''
        detachable : bool
        id_ : str
        provider_id : str
...
class RelationStatusArg(Type):
    _toSchema = {'message': 'message', 'relation_id': 'relation-id', 'status': 'status'}
    _toPy = {'message': 'message', 'relation-id': 'relation_id', 'status': 'status'}
    def __init__(self, message=None, relation_id=None, status=None, **unknown_fields):
        '''
        message : str
        relation_id : int
        status : str
...
class RemoteRelationChangeEvent(Type):
    _toSchema = {'application_token': 'application-token', 'changed_units': 'changed-units', 'departed_units': 'departed-units', 'life': 'life', 'macaroons': 'macaroons', 'relation_token': 'relation-token', 'suspended': 'suspended', 'suspended_reason': 'suspended-reason'}
    _toPy = {'application-token': 'application_token', 'changed-units': 'changed_units', 'departed-units': 'departed_units', 'life': 'life', 'macaroons': 'macaroons', 'relation-token': 'relation_token', 'suspended': 'suspended', 'suspended-reason': 'suspended_reason'}
    def __init__(self, application_token=None, changed_units=None, departed_units=None, life=None, macaroons=None, relation_token=None, suspended=None, suspended_reason=None, **unknown_fields):
        '''
        application_token : str
...
class UnitRefreshResult(Type):
    _toSchema = {'error': 'Error', 'life': 'Life', 'resolved': 'Resolved', 'series': 'Series'}
    _toPy = {'Error': 'error', 'Life': 'life', 'Resolved': 'resolved', 'Series': 'series'}
    def __init__(self, error=None, life=None, resolved=None, series=None, **unknown_fields):
        '''
        error : Error
        life : str
        resolved : str
