...
class ActionPrunerFacade(Type):
    ...
    async def Prune(self, max_history_mb=None, max_history_time=None):
        ...
        if max_history_mb is not None and not isinstance(max_history_mb, int):
            raise Exception("max_history_mb must be: int got: {}".format(type(max_history_mb).__name__))

        if max_history_time is not None and not isinstance(max_history_time, int):
            raise Exception("max_history_time must be: int got: {}".format(type(max_history_time).__name__))
...
class BackupsFacade(Type):
    ...
    async def Create(self, notes=None):
        ...
        if notes is not None and not isinstance(notes, (bytes, str)):
            raise Exception("notes must be: str got: {}".format(type(notes).__name__))
    ...
    async def Info(self, id_=None):
        ...
        if id_ is not None and not isinstance(id_, (bytes, str)):
            raise Exception("id_ must be: str got: {}".format(type(id_).__name__))
    ...
    async def Restore(self, backup_id=None):
        ...
        if backup_id is not None and not isinstance(backup_id, (bytes, str)):
            raise Exception("backup_id must be: str got: {}".format(type(backup_id).__name__))
...
class BundleFacade(Type):
    ...
    async def GetChanges(self, yaml=None):
        ...
        if yaml is not None and not isinstance(yaml, (bytes, str)):
            raise Exception("yaml must be: str got: {}".format(type(yaml).__name__))
...
class CAASOperatorFacade(Type):
    ...
    async def SetTools(self, agent_tools=None):
        ...
        if agent_tools is not None and not isinstance(agent_tools, list):
            raise Exception("agent_tools must be: Sequence got: {}".format(type(agent_tools).__name__))
...
class CAASOperatorUpgraderFacade(Type):
    ...
    async def UpgradeOperator(self, agent_tag=None, version=None):
        ...
        if agent_tag is not None and not isinstance(agent_tag, (bytes, str)):
            raise Exception("agent_tag must be: str got: {}".format(type(agent_tag).__name__))

        if version is not None and not isinstance(version, (dict, set, Number)):
            raise Exception("version must be: Number got: {}".format(type(version).__name__))
...
class ClientFacade(Type):
    ...
    async def AddCharm(self, channel=None, url=None):
        ...
        if url is not None and not isinstance(url, (bytes, str)):
            raise Exception("url must be: str got: {}".format(type(url).__name__))
    ...
    async def AddCharmWithAuthorization(self, channel=None, macaroon=None, url=None):
        ...
        if macaroon is not None and not isinstance(macaroon, (dict, set, Macaroon)):
            raise Exception("macaroon must be: Macaroon got: {}".format(type(macaroon).__name__))
    ...
    async def DestroyMachines(self, force=None, machine_names=None):
        ...
        if machine_names is not None and not isinstance(machine_names, list):
            raise Exception("machine_names must be: Sequence got: {}".format(type(machine_names).__name__))
    ...
    async def FullStatus(self, patterns=None):
        ...
        if patterns is not None and not isinstance(patterns, list):
            raise Exception("patterns must be: Sequence got: {}".format(type(patterns).__name__))
    ...
    async def ModelSet(self, config=None):
        ...
        if config is not None and not isinstance(config, (dict, set)):
            raise Exception("config must be: Mapping got: {}".format(type(config).__name__))
    ...
    async def ModelUnset(self, keys=None):
        ...
        if keys is not None and not isinstance(keys, list):
            raise Exception("keys must be: Sequence got: {}".format(type(keys).__name__))
    ...
    async def PrivateAddress(self, target=None):
        ...
        if target is not None and not isinstance(target, (bytes, str)):
            raise Exception("target must be: str got: {}".format(type(target).__name__))
    ...
    async def ProvisioningScript(self, data_dir=None, disable_package_commands=None, machine_id=None, nonce=None):
        ...
        if data_dir is not None and not isinstance(data_dir, (bytes, str)):
            raise Exception("data_dir must be: str got: {}".format(type(data_dir).__name__))

        if disable_package_commands is not None and not isinstance(disable_package_commands, bool):
            raise Exception("disable_package_commands must be: bool got: {}".format(type(disable_package_commands).__name__))

        if machine_id is not None and not isinstance(machine_id, (bytes, str)):
            raise Exception("machine_id must be: str got: {}".format(type(machine_id).__name__))

        if nonce is not None and not isinstance(nonce, (bytes, str)):
            raise Exception("nonce must be: str got: {}".format(type(nonce).__name__))
    ...
    async def ResolveCharms(self, references=None):
        ...
        if references is not None and not isinstance(references, list):
            raise Exception("references must be: Sequence got: {}".format(type(references).__name__))
    ...
    async def Resolved(self, retry=None, unit_name=None):
        ...
        if unit_name is not None and not isinstance(unit_name, (bytes, str)):
            raise Exception("unit_name must be: str got: {}".format(type(unit_name).__name__))
    ...
    async def SetSLALevel(self, modelslainfo=None, creds=None):
        ...
        if modelslainfo is not None and not isinstance(modelslainfo, (dict, set, ModelSLAInfo)):
            raise Exception("modelslainfo must be: ModelSLAInfo got: {}".format(type(modelslainfo).__name__))
    ...
    async def StatusHistory(self, requests=None):
        ...
        if requests is not None and not isinstance(requests, list):
            raise Exception("requests must be: Sequence got: {}".format(type(requests).__name__))
...
class CloudFacade(Type):
    ...
    async def InstanceTypes(self, constraints=None):
        ...
        if constraints is not None and not isinstance(constraints, list):
            raise Exception("constraints must be: Sequence got: {}".format(type(constraints).__name__))
    ...
    async def UpdateCredentials(self, credentials=None):
        ...
        if credentials is not None and not isinstance(credentials, list):
            raise Exception("credentials must be: Sequence got: {}".format(type(credentials).__name__))
    ...
    async def UserCredentials(self, user_clouds=None):
        ...
        if user_clouds is not None and not isinstance(user_clouds, list):
            raise Exception("user_clouds must be: Sequence got: {}".format(type(user_clouds).__name__))
...
class CredentialManagerFacade(Type):
    ...
    async def InvalidateModelCredential(self, reason=None):
        ...
        if reason is not None and not isinstance(reason, (bytes, str)):
            raise Exception("reason must be: str got: {}".format(type(reason).__name__))
...
class CrossModelRelationsFacade(Type):
    ...
    async def RegisterRemoteRelations(self, relations=None):
        ...
        if relations is not None and not isinstance(relations, list):
            raise Exception("relations must be: Sequence got: {}".format(type(relations).__name__))
...
class ExternalControllerUpdaterFacade(Type):
    ...
    async def SetExternalControllerInfo(self, controllers=None):
        ...
        if controllers is not None and not isinstance(controllers, list):
            raise Exception("controllers must be: Sequence got: {}".format(type(controllers).__name__))
...
class HostKeyReporterFacade(Type):
    ...
    async def ReportKeys(self, entity_keys=None):
        ...
        if entity_keys is not None and not isinstance(entity_keys, list):
            raise Exception("entity_keys must be: Sequence got: {}".format(type(entity_keys).__name__))
...
class KeyManagerFacade(Type):
    ...
    async def AddKeys(self, ssh_keys=None, user=None):
        ...
        if ssh_keys is not None and not isinstance(ssh_keys, list):
            raise Exception("ssh_keys must be: Sequence got: {}".format(type(ssh_keys).__name__))

        if user is not None and not isinstance(user, (bytes, str)):
            raise Exception("user must be: str got: {}".format(type(user).__name__))
    ...
    async def ListKeys(self, entities=None, mode=None):
        ...
        Returns -> typing.Sequence[~StringsResult]
        '''
        if entities is not None and not isinstance(entities, (dict, set, Entities)):
            raise Exception("entities must be: Entities got: {}".format(type(entities).__name__))

        if mode is not None and not isinstance(mode, bool):
            raise Exception("mode must be: bool got: {}".format(type(mode).__name__))
...
class MachinerFacade(Type):
    ...
    async def SetMachineAddresses(self, machine_addresses=None):
        ...
        if machine_addresses is not None and not isinstance(machine_addresses, list):
            raise Exception("machine_addresses must be: Sequence got: {}".format(type(machine_addresses).__name__))
...
class MigrationMasterFacade(Type):
    ...
    async def SetPhase(self, phase=None):
        ...
        if phase is not None and not isinstance(phase, (bytes, str)):
            raise Exception("phase must be: str got: {}".format(type(phase).__name__))
    ...
    async def SetStatusMessage(self, message=None):
        ...
        if message is not None and not isinstance(message, (bytes, str)):
            raise Exception("message must be: str got: {}".format(type(message).__name__))
...
class MigrationMinionFacade(Type):
    ...
    async def Report(self, migration_id=None, phase=None, success=None):
        ...
        if migration_id is not None and not isinstance(migration_id, (bytes, str)):
            raise Exception("migration_id must be: str got: {}".format(type(migration_id).__name__))

        if phase is not None and not isinstance(phase, (bytes, str)):
            raise Exception("phase must be: str got: {}".format(type(phase).__name__))

        if success is not None and not isinstance(success, bool):
            raise Exception("success must be: bool got: {}".format(type(success).__name__))
...
class MigrationTargetFacade(Type):
    ...
    async def Abort(self, model_tag=None):
        ...
        if model_tag is not None and not isinstance(model_tag, (bytes, str)):
            raise Exception("model_tag must be: str got: {}".format(type(model_tag).__name__))
    ...
    async def AdoptResources(self, model_tag=None, source_controller_version=None):
        ...
        if source_controller_version is not None and not isinstance(source_controller_version, (dict, set, Number)):
            raise Exception("source_controller_version must be: Number got: {}".format(type(source_controller_version).__name__))
    ...
    async def Import(self, bytes_=None, charms=None, resources=None, tools=None):
        ...
        if bytes_ is not None and not isinstance(bytes_, list):
            raise Exception("bytes_ must be: Sequence got: {}".format(type(bytes_).__name__))

        if charms is not None and not isinstance(charms, list):
            raise Exception("charms must be: Sequence got: {}".format(type(charms).__name__))

        if resources is not None and not isinstance(resources, list):
            raise Exception("resources must be: Sequence got: {}".format(type(resources).__name__))

        if tools is not None and not isinstance(tools, list):
            raise Exception("tools must be: Sequence got: {}".format(type(tools).__name__))
    ...
    async def Prechecks(self, agent_version=None, controller_agent_version=None, name=None, owner_tag=None, uuid=None):
        ...
        Returns -> None
        '''
        if agent_version is not None and not isinstance(agent_version, (dict, set, Number)):
            raise Exception("agent_version must be: Number got: {}".format(type(agent_version).__name__))

        if controller_agent_version is not None and not isinstance(controller_agent_version, (dict, set, Number)):
            raise Exception("controller_agent_version must be: Number got: {}".format(type(controller_agent_version).__name__))

        if name is not None and not isinstance(name, (bytes, str)):
            raise Exception("name must be: str got: {}".format(type(name).__name__))

        if owner_tag is not None and not isinstance(owner_tag, (bytes, str)):
            raise Exception("owner_tag must be: str got: {}".format(type(owner_tag).__name__))

        if uuid is not None and not isinstance(uuid, (bytes, str)):
            raise Exception("uuid must be: str got: {}".format(type(uuid).__name__))
...
class ModelGenerationFacade(Type):
    ...
    async def BranchInfo(self, branches=None, detailed=None):
        ...
        if branches is not None and not isinstance(branches, list):
            raise Exception("branches must be: Sequence got: {}".format(type(branches).__name__))

        if detailed is not None and not isinstance(detailed, bool):
            raise Exception("detailed must be: bool got: {}".format(type(detailed).__name__))
...
class ModelUpgraderFacade(Type):
    ...
    async def SetModelEnvironVersion(self, models=None):
        ...
        if models is not None and not isinstance(models, list):
            raise Exception("models must be: Sequence got: {}".format(type(models).__name__))
...
class PayloadsHookContextFacade(Type):
    ...
    async def Track(self, payloads=None):
        ...
        if payloads is not None and not isinstance(payloads, list):
            raise Exception("payloads must be: Sequence got: {}".format(type(payloads).__name__))
...
class ResourcesFacade(Type):
    ...
    async def AddPendingResources(self, addcharmwithauthorization=None, entity=None, channel=None, force=None, macaroon=None, resources=None, tag=None, url=None):
        ...
        '''
        if addcharmwithauthorization is not None and not isinstance(addcharmwithauthorization, (dict, set, AddCharmWithAuthorization)):
            raise Exception("addcharmwithauthorization must be: AddCharmWithAuthorization got: {}".format(type(addcharmwithauthorization).__name__))

        if entity is not None and not isinstance(entity, (dict, set, Entity)):
            raise Exception("entity must be: Entity got: {}".format(type(entity).__name__))
...
class ResourcesHookContextFacade(Type):
    ...
    async def GetResourceInfo(self, resource_names=None):
        ...
        if resource_names is not None and not isinstance(resource_names, list):
            raise Exception("resource_names must be: Sequence got: {}".format(type(resource_names).__name__))
...
class SingularFacade(Type):
    ...
    async def Claim(self, claims=None):
        ...
        if claims is not None and not isinstance(claims, list):
            raise Exception("claims must be: Sequence got: {}".format(type(claims).__name__))
...
class UserManagerFacade(Type):
    ...
    async def AddUser(self, users=None):
        ...
        if users is not None and not isinstance(users, list):
            raise Exception("users must be: Sequence got: {}".format(type(users).__name__))
    ...
    async def UserInfo(self, entities=None, include_disabled=None):
        ...
        if include_disabled is not None and not isinstance(include_disabled, bool):
            raise Exception("include_disabled must be: bool got: {}".format(type(include_disabled).__name__))
