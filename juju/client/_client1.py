...
class CharmHubFacade(Type):
    ...
    def Find(self, category=None, channel=None, platforms=None, publisher=None, query=None, relation_provides=None, relation_requires=None, type_=None):
        '''
    ...
    def Info(self, channel=None, tag=None):
        '''
