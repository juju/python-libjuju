...
from juju.client import _client1, _client2, _client3, _client4, _client5, _client7
...
class TypeFactory:
    ...
    def from_connection(cls, connection):
        ...
        if version is None:
            raise Exception('No facade {} in facades {}'.format(
                facade_name, connection.facades))
